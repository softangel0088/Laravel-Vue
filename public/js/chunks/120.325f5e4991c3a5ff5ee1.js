...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      if (_store_index__WEBPACK_IMPORTED_MODULE_6__["default"].state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = __webpack_require__(/*! @/assets/images/pages/flat-bg2.jpg */ "./resources/js/src/assets/images/pages/flat-bg2.jpg");
        return this.sideImg;
      }
  ...
  setup: function setup() {
    var status = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])();
    var password = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])();
    var userEmail = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])();

    var sideImg = __webpack_require__(/*! @/assets/images/pages/flat-bg2.jpg */ "./resources/js/src/assets/images/pages/flat-bg2.jpg");

    var logoUrl = __webpack_require__(/*! @/assets/images/logo/logo.png */ "./resources/js/src/assets/images/logo/logo.png");

    var logoUrlWhite = __webpack_require__(/*! @/assets/images/logo/logo-white.png */ "./resources/js/src/assets/images/logo/logo-white.png");
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].setToken(response.data.access_token);
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].setRefreshToken(response.data.refresh_token);
            localStorage.setItem('userData', JSON.stringify(userData));

            _this.$router.push(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_7__["getHomeRouteForLoggedInUser"])(userData.is_admin)).then(function (resp) {
              console.log(resp);
              debugger;
            ...
            console.log('here');
            debugger; // console.log(error.response.status === 401)
            // console.log(error.response.status ===  200)
            // console.log(error.response.status === 459)

            if (error.response.status === 401) {
              if (error.response.data) _this.$toast({
                component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
                position: 'top-right',
                props: {
                  ...
                  variant: 'danger',
                  text: "".concat(error.response.data.error, " ")
                }
              });
            } else {
              _this.$toast({
          ...
          [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("b-link", { attrs: { to: { name: "auth-register" } } }, [
...
module.exports = "/images/_/_/_/_/master-uping-new/resources/js/src/assets/images/pages/flat-bg2.jpg";
