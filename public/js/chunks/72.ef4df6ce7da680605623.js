...
/* harmony import */ var _apps_partnerdashboard_uk_lead_LeadStoreModule__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../apps/partnerdashboard/uk-lead/LeadStoreModule */ "./resources/js/src/views/apps/partnerdashboard/uk-lead/LeadStoreModule.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var userData = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_8__["getUserData"])();
    console.log(userData.id);
    axios__WEBPACK_IMPORTED_MODULE_9___default.a.get("https://portal.uping.co.uk/api/admin/getUserData/".concat(userData.id)).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateAccountSettingsForm: function updateAccountSettingsForm(ev) {
      var _this = this;
      ...
      this.$http.patch('/partner/updateAccountInfo/1', this.userData).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateCompanyInfo: function updateCompanyInfo(ev) {
      var _this = this;
      ...
      this.$http.patch('/partner/updateCompany/1', this.userData.user.company).then(function (res) {
        // console.log(res)
        // debugger
        _this.$toast({
