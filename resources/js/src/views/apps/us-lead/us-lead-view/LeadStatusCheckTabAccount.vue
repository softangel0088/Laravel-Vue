    ...
    <b-media class="mb-2">
      ...
      >
          ...
          <template #cell(lender_found)="data">
              <b-badge v-if="data.item.lender_found == 1" pill variant="primary">
              Accept
              </b-badge>
              <b-badge v-else-if="data.item.lender_found == 2" pill variant="danger">
              Declined
              </b-badge>
              <b-badge v-else-if="data.item.lender_found == 3" pill variant="warning">
                  Pending
              </b-badge>
          </template>
